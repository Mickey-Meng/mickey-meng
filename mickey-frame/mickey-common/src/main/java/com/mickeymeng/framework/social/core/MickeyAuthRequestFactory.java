package com.mickeymeng.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.mickeymeng.framework.social.core.enums.AuthExtendSource;
import com.mickeymeng.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class  MickeyAuthRequestFactory extends AuthRequestFactory {
    ...
    public MickeyAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
