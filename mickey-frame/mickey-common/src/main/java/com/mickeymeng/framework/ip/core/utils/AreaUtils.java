package com.mickeymeng.framework.ip.core.utils;
...
import com.mickeymeng.framework.ip.core.enums.AreaTypeEnum;
...
public class AreaUtils {
    ...
    private AreaUtils() {
        ...
        areas.put(Area.ID_GLOBAL, new Area(Area.ID_GLOBAL, "全球", 0,
                null, new ArrayList<>()));
        // 从 csv 中加载数据
        List<CsvRow> rows = CsvUtil.getReader().read(ResourceUtil.getUtf8Reader("ip-info/area.csv")).getRows();
