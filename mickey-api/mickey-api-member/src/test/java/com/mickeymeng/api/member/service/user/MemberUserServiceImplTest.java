package com.mickeymeng.api.member.service.user;
...
import com.mickeymeng.api.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, RedisAutoConfiguration.class})
public class MemberUserServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    public void testUpdateNickName_success(){
        ...
        // 随机昵称
        String newNickName = RandomUtils.randomString();
    ...
    public void testUpdateAvatar_success() throws Exception {
        ...
        // mock 方法
        String avatar = RandomUtils.randomString();
