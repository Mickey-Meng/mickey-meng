...
import com.mickeymeng.api.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import com.mickeymeng.api.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
 ...
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, RedisAutoConfiguration.class})
public class MemberAuthServiceTest extends BaseDbAndRedisUnitTest {
    ...
    private static MemberUserDO randomUserDO(Consumer<MemberUserDO>... consumers) {
        Consumer<MemberUserDO> consumer = (o) -> {
            ...
            o.setPassword(RandomUtils.randomString());
        };
        return RandomUtils.randomPojo(MemberUserDO.class, ArrayUtils.append(consumer, consumers));
    }
