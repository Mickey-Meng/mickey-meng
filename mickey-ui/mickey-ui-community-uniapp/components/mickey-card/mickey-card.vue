...
import mickeyParse from '@/components/mickey-parse/mickey-parse.vue'
...
.u-card {
	...
	&__head {
		...
		&--right {
			color: $u-tips-color;
			//margin-left: 6rpx; // edit by mickey
			text-align: right; // edit by mickey
			vertical-align:middle; // edit by mickey
			margin-top: -39rpx; // edit by mickey
		}
	}
