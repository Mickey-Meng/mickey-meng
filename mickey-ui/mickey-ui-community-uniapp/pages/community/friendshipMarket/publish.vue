        ...
        <view class="u-demo-block">
 	        <view class="u-demo-block__content">
                ...
                <u--form labelPosition="left" :model="model1"  ref="form1"  >
                    ...
                    <u-form-item  label="取件地址"  prop="userInfo.sex"  borderBottom  @click="showAddressProp = true; hideKeyboard()"	ref="item1">
	                    <u-icon name="car-fill" color="#2979ff" size="28"></u-icon>
                        <u--input v-model="model1.userInfo.sex" disabled disabledColor="#ffffff" placeholder="请选择性别" border="none"></u--input>
	                    <u-icon slot="right" name="arrow-right"	></u-icon>
                    </u-form-item>
                    <u-form-item  label="收件地址"  prop="userInfo.sex"  borderBottom  @click="showAddressProp = true; hideKeyboard()"	ref="item1">
	                    <u-icon name="car-fill" color="#2979ff" size="28"></u-icon>
                        <u--input v-model="model1.userInfo.sex" disabled disabledColor="#ffffff" placeholder="请选择性别" border="none"></u--input>
	                    <u-icon slot="right" name="arrow-right"	></u-icon>
                    </u-form-item>
                    ...
                    <u-form-item  label="住店时间"	prop="hotel"  labelWidth="80"	borderBottom  @click="showCalendar = true; hideKeyboard()">
	                    <u--input v-model="model1.hotel" disabled disabledColor="#ffffff" placeholder="请选择住店和离店时间" border="none"></u--input>
	                    <u-icon slot="right" name="arrow-right"	></u-icon>
                    </u-form-item>
                    ...
                    <u-form-item  label="生日"	prop="userInfo.birthday"  borderBottom	@click="showBirthday = true; hideKeyboard()" ref="item1">
	                    <u--input v-model="model1.userInfo.birthday" disabled disabledColor="#ffffff"  placeholder="请选择生日" border="none"></u--input>
	                    <u-icon slot="right" name="arrow-right"	></u-icon>
                    </u-form-item>
                </u--form>
                ...
                <u-calendar :show="showCalendar" mode="range" @confirm="calendarConfirm" @close="calendarClose" startText="住店" endText="离店" confirmDisabledText="请选择离店日期" :formatter="formatter"></u-calendar>
                <u-code ref="uCode" @change="codeChange" seconds="20" @start="disabled1 = true" @end="disabled1 = false"  ></u-code>
                <u-datetime-picker :show="showBirthday" :value="birthday" mode="date" closeOnClickOverlay @confirm="birthdayConfirm" @cancel="birthdayClose" @close="birthdayClose" ></u-datetime-picker>
 	        

                <u-action-sheet :show="showAddressProp" :actions="addressList" title="请选择地址" description="如果选择保密会报错" @close="showAddressProp = false" @select="sexSelect" ></u-action-sheet>
	...
	export default {
        ...
        methods: {
            addressSelect(address) {
                ...
                this.model1.userInfo.sex = address.area || address.detail;
