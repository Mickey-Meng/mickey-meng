/**
 * Copyright (c) 2023 http://www.mickeymeng.com All rights reserved.
 */
...
const install = (Vue, vm) => {
	...
	vm.$u.api = {
		...
		login: (params = {}) => vm.$u.post(config.adminPath+'/login/loginByPassword', params),
		//login: (params = {}) => vm.$u.post(config.adminPath+'/system/auth/login', params),
		
		sendCode: (params = {}) => vm.$u.post(config.adminPath+'/login/sendCode', params),
