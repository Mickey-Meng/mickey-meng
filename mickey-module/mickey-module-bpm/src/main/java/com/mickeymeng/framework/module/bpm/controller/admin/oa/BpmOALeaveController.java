package com.mickeymeng.framework.module.bpm.controller.admin.oa;
...
import com.mickeymeng.framework.module.bpm.controller.admin.oa.vo.BpmOALeaveRespVO;
...
import com.mickeymeng.framework.module.bpm.service.oa.BpmOALeaveService;
...
public class BpmOALeaveController {
    ...
    public CommonResult<Long> createLeave(@Valid @RequestBody BpmOALeaveCreateReqVO createReqVO) {
        return success(leaveService.createLeave(SecurityFrameworkUtils.getLoginUserId(), createReqVO));
    }
    ...
    public CommonResult<PageResult<BpmOALeaveRespVO>> getLeavePage(@Valid BpmOALeavePageReqVO pageVO) {
        PageResult<BpmOALeaveDO> pageResult = leaveService.getLeavePage(SecurityFrameworkUtils.getLoginUserId(), pageVO);
