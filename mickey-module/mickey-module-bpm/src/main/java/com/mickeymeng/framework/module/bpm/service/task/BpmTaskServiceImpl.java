package com.mickeymeng.framework.module.bpm.service.task;
...
import com.mickeymeng.framework.common.core.util.object.PageUtils;
...
import com.mickeymeng.framework.module.bpm.convert.task.BpmTaskConvert;
import com.mickeymeng.framework.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import com.mickeymeng.framework.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import com.mickeymeng.framework.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import com.mickeymeng.framework.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import com.mickeymeng.framework.module.bpm.service.message.BpmMessageService;
...
import static com.mickeymeng.framework.module.bpm.enums.ErrorCodeConstants.*;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public PageResult<BpmTaskTodoPageItemRespVO> getTodoTaskPage(Long userId, BpmTaskTodoPageReqVO pageVO) {
        ...
        Map<String, ProcessInstance> processInstanceMap =
            processInstanceService.getProcessInstanceMap(CollectionUtils.convertSet(tasks, Task::getProcessInstanceId));
        // 获得 User Map
        Map<Long, AdminUserRespDTO> userMap = adminUserApi.getUserMap(
                CollectionUtils.convertSet(processInstanceMap.values(), instance -> Long.valueOf(instance.getStartUserId())));
        // 拼接结果
    ...
    public PageResult<BpmTaskDonePageItemRespVO> getDoneTaskPage(Long userId, BpmTaskDonePageReqVO pageVO) {
        ...
        List<BpmTaskExtDO> bpmTaskExtDOs =
            taskExtMapper.selectListByTaskIds(CollectionUtils.convertSet(tasks, HistoricTaskInstance::getId));
        ...
        Map<String, HistoricProcessInstance> historicProcessInstanceMap =
            processInstanceService.getHistoricProcessInstanceMap(
                    CollectionUtils.convertSet(tasks, HistoricTaskInstance::getProcessInstanceId));
        // 获得 User Map
        Map<Long, AdminUserRespDTO> userMap = adminUserApi.getUserMap(
                CollectionUtils.convertSet(historicProcessInstanceMap.values(), instance -> Long.valueOf(instance.getStartUserId())));
        // 拼接结果
    ...
    public List<BpmTaskRespVO> getTaskListByProcessInstanceId(String processInstanceId) {
        ...
        // 获得 TaskExtDO Map
        List<BpmTaskExtDO> bpmTaskExtDOs = taskExtMapper.selectListByTaskIds(CollectionUtils.convertSet(tasks, HistoricTaskInstance::getId));
        Map<String, BpmTaskExtDO> bpmTaskExtDOMap = CollectionUtils.convertMap(bpmTaskExtDOs, BpmTaskExtDO::getTaskId);
        // 获得 ProcessInstance Map
        HistoricProcessInstance processInstance = processInstanceService.getHistoricProcessInstance(processInstanceId);
        // 获得 User Map
        Set<Long> userIds = CollectionUtils.convertSet(tasks, task -> NumberUtils.parseLong(task.getAssignee()));
        userIds.add(NumberUtils.parseLong(processInstance.getStartUserId()));
        Map<Long, AdminUserRespDTO> userMap = adminUserApi.getUserMap(userIds);
        // 获得 Dept Map
        Map<Long, DeptRespDTO> deptMap = deptApi.getDeptMap(CollectionUtils.convertSet(userMap.values(), AdminUserRespDTO::getDeptId));
