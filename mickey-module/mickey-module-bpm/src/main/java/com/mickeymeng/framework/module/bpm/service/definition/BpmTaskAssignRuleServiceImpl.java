package com.mickeymeng.framework.module.bpm.service.definition;
...
import com.mickeymeng.framework.common.service.api.*;
...
import com.mickeymeng.framework.datapermission.core.annotation.DataPermission;
import com.mickeymeng.framework.middleware.flowable.core.util.FlowableUtils;
import com.mickeymeng.framework.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import com.mickeymeng.framework.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import com.mickeymeng.framework.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import com.mickeymeng.framework.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import com.mickeymeng.framework.module.bpm.convert.definition.BpmTaskAssignRuleConvert;
...
import com.mickeymeng.framework.module.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import com.mickeymeng.framework.module.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
import com.mickeymeng.framework.module.bpm.enums.DictTypeConstants;
import com.mickeymeng.framework.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
    ...
    Set<Long> calculateTaskCandidateUsers(DelegateExecution execution, BpmTaskAssignRuleDO rule) {
        ...
        if (CollUtil.isEmpty(assigneeUserIds)) {
            log.error("[calculateTaskCandidateUsers][流程任务({}/{}/{}) 任务规则({}) 找不到候选人]", execution.getId(),
                    execution.getProcessDefinitionId(), execution.getCurrentActivityId(), JsonUtils.toJsonString(rule));
