...
import com.mickeymeng.framework.module.pay.controller.admin.merchant.vo.merchant.*;
import com.mickeymeng.framework.module.pay.convert.merchant.PayMerchantConvert;
...
public class PayMerchantController {
    ...
    public CommonResult<Long> createMerchant(@Valid @RequestBody PayMerchantCreateReqVO createReqVO) {
        return CommonResult.success(merchantService.createMerchant(createReqVO));
    }
    ...
    public CommonResult<PayMerchantRespVO> getMerchant(@RequestParam("id") Long id) {
        ...
        return CommonResult.success(PayMerchantConvert.INSTANCE.convert(merchant));
    }
    ...
    public CommonResult<List<PayMerchantRespVO>> getMerchantListByName(@RequestParam(required = false) String name) {
        ...
        return CommonResult.success(PayMerchantConvert.INSTANCE.convertList(merchantListDO));
    }
    ...
    public CommonResult<List<PayMerchantRespVO>> getMerchantList(@RequestParam("ids") Collection<Long> ids) {
        ...
        return CommonResult.success(PayMerchantConvert.INSTANCE.convertList(list));
    }
    ...
    public CommonResult<PageResult<PayMerchantRespVO>> getMerchantPage(@Valid PayMerchantPageReqVO pageVO) {
        ...
        return CommonResult.success(PayMerchantConvert.INSTANCE.convertPage(pageResult));
    }
