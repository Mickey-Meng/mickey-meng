...
import com.mickeymeng.framework.module.pay.convert.app.PayAppConvert;
...
import com.mickeymeng.framework.module.pay.dal.mysql.merchant.PayAppMapper;
import com.mickeymeng.framework.module.pay.dal.mysql.merchant.PayMerchantMapper;
...
import static com.mickeymeng.framework.module.pay.enums.ErrorCodeConstants.*;
...
public class PayAppServiceImpl implements PayAppService {
    ...
    private Set<Long> getMerchantCondition(String merchantName) {
        ...
        return CollectionUtils.convertSet(merchantMapper.getMerchantListByName(merchantName), PayMerchantDO::getId);
    }
    ...
    private void validateOrderTransactionExist(Long appId) {
        ...
        if (orderMapper.selectCount(appId, PayOrderStatusEnum.WAITING.getStatus()) > 0) {
            throw ServiceExceptionUtil.exception(PAY_APP_EXIST_TRANSACTION_ORDER_CANT_DELETE);
        }
        // 查看退款订单
