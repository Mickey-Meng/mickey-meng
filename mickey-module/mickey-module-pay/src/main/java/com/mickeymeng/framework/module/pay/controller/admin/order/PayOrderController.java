package com.mickeymeng.framework.module.pay.controller.admin.order;
...
import com.mickeymeng.framework.module.pay.controller.admin.order.vo.*;
...
import com.mickeymeng.framework.module.pay.service.merchant.PayMerchantService;
...
public class PayOrderController {
    ...
    public CommonResult<PayOrderDetailsRespVO> getOrder(@RequestParam("id") Long id) {
        ...
        if (ObjectUtil.isNull(order)) {
            return CommonResult.success(new PayOrderDetailsRespVO());
        }
    ...
    public CommonResult<PageResult<PayOrderPageItemRespVO>> getOrderPage(@Valid PayOrderPageReqVO pageVO) {
        ...
        if (CollectionUtil.isEmpty(pageResult.getList())) {
            return CommonResult.success(new PageResult<>(pageResult.getTotal()));
        }
        ...
        return CommonResult.success(new PageResult<>(pageList, pageResult.getTotal()));
    }
