package com.mickeymeng.framework.module.pay.controller.admin.refund;
...
import com.mickeymeng.framework.module.pay.controller.admin.refund.vo.*;
import com.mickeymeng.framework.module.pay.convert.refund.PayRefundConvert;
...
public class PayRefundController {
    ...
    public CommonResult<PayRefundDetailsRespVO> getRefund(@RequestParam("id") Long id) {
        ...
        if (ObjectUtil.isNull(refund)) {
            return CommonResult.success(new PayRefundDetailsRespVO());
        }
