package com.mickeymeng.framework.module.pay.convert.order;
...
import com.mickeymeng.framework.module.pay.api.order.dto.PayOrderRespDTO;
import com.mickeymeng.framework.module.pay.controller.admin.order.vo.PayOrderDetailsRespVO;
import com.mickeymeng.framework.module.pay.controller.admin.order.vo.PayOrderExcelVO;
import com.mickeymeng.framework.module.pay.controller.admin.order.vo.PayOrderPageItemRespVO;
import com.mickeymeng.framework.module.pay.controller.admin.order.vo.PayOrderRespVO;
...
public interface PayOrderConvert {
    ...
    default PayOrderExcelVO excelConvert(PayOrderDO bean) {
        ...
        payOrderExcelVO.setChannelFeeAmount(BigDecimal.valueOf(bean.getChannelFeeAmount())
                .divide(multiple, 2, RoundingMode.HALF_UP).toString());
        payOrderExcelVO.setChannelFeeRate(BigDecimal.valueOf(bean.getChannelFeeRate())
