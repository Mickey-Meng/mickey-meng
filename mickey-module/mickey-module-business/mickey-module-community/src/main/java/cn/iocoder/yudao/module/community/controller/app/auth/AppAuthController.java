package cn.iocoder.yudao.module.community.controller.app.auth;
...
import cn.iocoder.yudao.module.community.service.auth.CommunityAuthService;
...
@Api(tags = "社区用户 APP - 认证")
@RestController
@RequestMapping("/community/mini/auth")
@Validated
@Slf4j
