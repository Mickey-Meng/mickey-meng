...
public interface CommunityUserService {
     ...
     * @return 用户对象
     */
    CommunityUserDO getUserByMobile(String mobile);
     ...
     * @return 用户信息的列表
     */
    List<CommunityUserDO> getUserListByNickname(String nickname);
     ...
     * @return 用户对象
     */
    CommunityUserDO createUserIfAbsent(@Mobile String mobile, String registerIp);
     ...
     * @return 用户对象信息
     */
    CommunityUserDO getUser(Long id);
     ...
     * @return 用户对象信息数组
     */
    List<CommunityUserDO> getUserList(Collection<Long> ids);
