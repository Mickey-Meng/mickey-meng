package cn.iocoder.yudao.module.community.controller.app.user;
...
import cn.iocoder.yudao.module.community.convert.user.UserConvert;
...
public class AppUserController {
    ...
    public CommonResult<AppUserInfoRespVO> getUserInfo() {
        CommunityUserDO user = userService.getUser(getLoginUserId());
