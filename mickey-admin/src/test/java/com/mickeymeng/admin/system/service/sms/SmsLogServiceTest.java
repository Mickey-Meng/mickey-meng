package com.mickeymeng.admin.system.service.sms;
...
import com.mickeymeng.admin.system.dal.mysql.sms.SmsLogMapper;
import com.mickeymeng.framework.common.enums.sms.SmsReceiveStatusEnum;
import com.mickeymeng.framework.common.enums.sms.SmsSendStatusEnum;
import com.mickeymeng.framework.common.enums.sms.SmsTemplateTypeEnum;
...
public class SmsLogServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateSmsLog() {
        // 准备参数
        String mobile = RandomUtils.randomString();
        Long userId = RandomUtils.randomLongId();
        Integer userType = randomEle(UserTypeEnum.values()).getValue();
        Boolean isSend = randomBoolean();
        SmsTemplateDO templateDO = RandomUtils.randomPojo(SmsTemplateDO.class,
                o -> o.setType(randomEle(SmsTemplateTypeEnum.values()).getType()));
        String templateContent = RandomUtils.randomString();
    ...
    public void testUpdateSmsSendResult() {
        ...
        Integer sendCode = RandomUtils.randomInteger();
        String sendMsg = RandomUtils.randomString();
        String apiSendCode = RandomUtils.randomString();
        String apiSendMsg = RandomUtils.randomString();
        String apiRequestId = RandomUtils.randomString();
        String apiSerialNo = RandomUtils.randomString();
    ...
    public void testUpdateSmsReceiveResult() {
        ...
        LocalDateTime receiveTime = RandomUtils.randomLocalDateTime();
        String apiReceiveCode = RandomUtils.randomString();
        String apiReceiveMsg = RandomUtils.randomString();
    ...
    private static SmsLogDO randomSmsLogDO(Consumer<SmsLogDO>... consumers) {
        ...
        return RandomUtils.randomPojo(SmsLogDO.class, ArrayUtils.append(consumer, consumers));
    }


    private static Map<String, Object> randomTemplateParams() {
        return MapUtil.<String, Object>builder().put(RandomUtils.randomString(), RandomUtils.randomString())
                .put(RandomUtils.randomString(), RandomUtils.randomString()).build();
    }
}
