...
import com.mickeymeng.admin.infra.service.test.TestDemoServiceImpl;
...
public class TestDemoServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTestDemo_success() {
        // 准备参数
        TestDemoCreateReqVO reqVO = RandomUtils.randomPojo(TestDemoCreateReqVO.class);
    ...
    public void testUpdateTestDemo_success() {
        // mock 数据
        TestDemoDO dbTestDemo = RandomUtils.randomPojo(TestDemoDO.class);
        testDemoMapper.insert(dbTestDemo);// @Sql: 先插入出一条存在的数据
        // 准备参数
        TestDemoUpdateReqVO reqVO = RandomUtils.randomPojo(TestDemoUpdateReqVO.class, o -> {
    ...
    public void testUpdateTestDemo_notExists() {
        // 准备参数
        TestDemoUpdateReqVO reqVO = RandomUtils.randomPojo(TestDemoUpdateReqVO.class);
    ...
    public void testGetTestDemoPage() {
        // mock 数据
        TestDemoDO dbTestDemo = RandomUtils.randomPojo(TestDemoDO.class, o -> { // 等会查询到
            o.setName("芋道源码");
