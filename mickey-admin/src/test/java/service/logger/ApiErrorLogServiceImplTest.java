...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateApiErrorLogProcess() {
        ...
        assertServiceException(() -> apiErrorLogService.updateApiErrorLogProcess(0L, ApiErrorLogProcessStatusEnum.DONE.getStatus(), processUserId), ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND);
        // id 为 first 的 progressStatus 为 DONE ，应该抛出 API_ERROR_LOG_PROCESSED
        assertServiceException(() -> apiErrorLogService.updateApiErrorLogProcess(firstId, ApiErrorLogProcessStatusEnum.DONE.getStatus(), processUserId), ErrorCodeConstants.API_ERROR_LOG_PROCESSED);
