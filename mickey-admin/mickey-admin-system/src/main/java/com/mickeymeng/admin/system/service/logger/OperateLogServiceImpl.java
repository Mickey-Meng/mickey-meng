...
import com.mickeymeng.framework.common.core.util.string.StrUtils;
import com.mickeymeng.framework.common.service.dto.OperateLogCreateReqDTO;
import com.mickeymeng.admin.system.controller.admin.logger.vo.operatelog.OperateLogExportReqVO;
import com.mickeymeng.admin.system.controller.admin.logger.vo.operatelog.OperateLogPageReqVO;
import com.mickeymeng.admin.system.convert.logger.OperateLogConvert;
...
import com.mickeymeng.admin.system.dal.mysql.logger.OperateLogMapper;
...
import static com.mickeymeng.admin.system.dal.dataobject.logger.OperateLogDO.JAVA_METHOD_ARGS_MAX_LENGTH;
import static com.mickeymeng.admin.system.dal.dataobject.logger.OperateLogDO.RESULT_MAX_LENGTH;
...
public class OperateLogServiceImpl implements OperateLogService {
    ...
    public PageResult<OperateLogDO> getOperateLogPage(OperateLogPageReqVO reqVO) {
        ...
        if (StrUtil.isNotEmpty(reqVO.getUserNickname())) {
            userIds = CollectionUtils.convertSet(userService.getUsersByNickname(reqVO.getUserNickname()), AdminUserDO::getId);
