...
import com.mickeymeng.framework.middleware.sms.core.property.SmsChannelProperties;
import com.mickeymeng.admin.system.controller.admin.sms.vo.channel.SmsChannelCreateReqVO;
import com.mickeymeng.admin.system.controller.admin.sms.vo.channel.SmsChannelPageReqVO;
import com.mickeymeng.admin.system.controller.admin.sms.vo.channel.SmsChannelUpdateReqVO;
import com.mickeymeng.admin.system.convert.sms.SmsChannelConvert;
import com.mickeymeng.admin.system.dal.dataobject.sms.SmsChannelDO;
import com.mickeymeng.admin.system.dal.mysql.sms.SmsChannelMapper;
...
import static com.mickeymeng.framework.common.constants.ErrorCodeConstants.SMS_CHANNEL_HAS_CHILDREN;
import static com.mickeymeng.framework.common.constants.ErrorCodeConstants.SMS_CHANNEL_NOT_EXISTS;
...
public class SmsChannelServiceImpl implements SmsChannelService {
    ...
    private void initLocalCacheIfUpdate(LocalDateTime maxUpdateTime) {
        ...
        this.maxUpdateTime = CollectionUtils.getMaxValue(channels, SmsChannelDO::getUpdateTime);
    }
