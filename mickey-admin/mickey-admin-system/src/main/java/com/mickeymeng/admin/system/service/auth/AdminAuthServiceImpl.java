package com.mickeymeng.admin.system.service.auth;
...
import com.mickeymeng.admin.system.controller.admin.auth.vo.*;
import com.mickeymeng.admin.system.convert.auth.AuthConvert;
...
public class AdminAuthServiceImpl implements AdminAuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${mickey.captcha.enable:true}")
